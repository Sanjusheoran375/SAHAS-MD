...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "IatRlCwT#RczZy4tzGPNDEXl2E-9vQcUO5D84LrSzUELx5XVJKdY",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || " SANJU",
  author: process.env.author || "SANJU-BHAI",
  //==========================================- API-CONFIGS -==========================================================
